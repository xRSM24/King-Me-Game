...
export const IDENTITIES: Record<IdentityId, IdentityDef> = {
  vagabond: {
    ...
    hp: 2,
    gold: 2,
    active: "Pin Pop — auto-fires. One pin the way you face, or at the nearest costume.",
  ...
  rat: {
    ...
    hp: 1,
    gold: 1,
    active: "Crumb Fan — auto-fires. Three snack crumbs in a spread.",
  ...
  guard: {
    ...
    hp: 3,
    gold: 3,
    active: "Pan Blast — auto-fires. A close shotgun of saucepan sparks.",
  ...
  archer: {
    ...
    hp: 2,
    gold: 3,
    active: "Rubber Bolt — auto-fires. One fast bolt, extra sting.",
  ...
  thief: {
    ...
    hp: 2,
    gold: 4,
    active: "Sneak X — auto-fires. Two diagonal shots. Sneaky angles.",
  ...
  priest: {
    ...
    hp: 3,
    gold: 3,
    active: "Soap Ring — auto-fires. Bubbles fly in every direction.",
  ...
  pyromancer: {
    ...
    hp: 3,
    gold: 4,
    active: "Chili Stream — auto-fires. Twin spicy jets. Fast and hot.",
  ...
  knight: {
    ...
    hp: 4,
    gold: 5,
    active: "Boop Cross — auto-fires. Four shots, plus-sign style.",
  ...
  hollow: {
    ...
    hp: 8,
    gold: 0,
    active: "Empty Ring — auto-fires. A ring of leftover hats.",
